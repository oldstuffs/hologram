package io.github.portlek.hologram.nms.v1_12_R1;
...
public class Hologram1_12_R1 implements Hologram {
    ...
    public void configureHologram(@NotNull Object entity, @NotNull String text, @NotNull Location location) {
        ...
        nmsEntity.setCustomName(Objects.requireNonNull(IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + text + "\"}")).getText());
