package io.github.portlek.hologram.nms.v1_11_R1;
...
public class Hologram1_11_R1 implements Hologram {
    ...
    public void configureHologram(@NotNull Object entity, @NotNull String text, @NotNull Location location) {
        ...
        nmsEntity.setCustomName(IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + text + "\"}").getText());
